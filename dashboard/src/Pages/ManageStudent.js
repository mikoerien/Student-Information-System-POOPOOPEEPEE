        ...
        <div className="view-container">
            ...
            <Modal open={modalOpen} onClose={handleCloseModal}>
                <Box sx={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', width: 400, bgcolor: 'background.paper', boxShadow: 24, p: 4 }}>
                    ...
                    <TextField variant="outlined" label="ID" value={editEmail} onChange={(e) => setEditEmail(e.target.value)} error={emailRequiredError} helperText={emailRequiredError && "Email is required"} />
                    <div style={{ marginBottom: '16px' }} />
            ...
            <Modal open={modalEditOpen} onClose={handleCloseModal}>
                <Box sx={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', width: 400, bgcolor: 'background.paper', boxShadow: 24, p: 4 }}>
                    ...
                    <div style={{ marginBottom: '16px' }} />
                    <TextField variant="outlined" label="ID" value={editEmail} onChange={(e) => setEditEmail(e.target.value)} disabled />
                    <div style={{ marginBottom: '16px' }} />
